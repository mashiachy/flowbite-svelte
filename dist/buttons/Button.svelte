...
const colorClasses = {
    ...
    alternative: 'text-primary-700 bg-white hover:bg-primary-100 focus:ring-gray-200 dark:bg-gray-800 dark:text-gray-400 hover:text-blue-700 focus:text-blue-700 dark:focus:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700',
    light: 'text-gray-900 bg-primary-100 hover:bg-primary-50 focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700',
    ...
    'primary-light': 'text-primary-700 bg-primary-100 hover:bg-primary-50 focus:bg-primary-700 focus:ring-primary-300 focus:text-white dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800',
...
const outlineClasses = {
    ...
    primary: 'text-primary-700 hover:text-white border border-primary-700 hover:bg-primary-700 focus:ring-primary-300 dark:border-primary-400 dark:text-primary-400 dark:hover:text-white dark:hover:bg-primary-500 dark:focus:ring-primary-900'
};
const sizeClasses = {
